...
function ProductList() {
    ...
    return (
        <div>
            ...
            {isCartOpen && (
                <div className="bg-gray-100 p-4 rounded-lg fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 max-w-lg max-h-96 overflow-y-auto"> {/* Estilos de Tailwind */}
